...
from homework.dcgan import dcgan
from homework.dcgan import trainer as tr
...
def main():
    ...
    discriminator, generator = dcgan.DCDiscriminator(config.image_size, nc=3), dcgan.DCGenerator(config.image_size, nc=3)

    trainer = tr.DCGANTrainer(generator=generator, discriminator=discriminator, device='cpu',
